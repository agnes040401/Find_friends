...
#theme = st.selectbox('Wybierz motyw:', ["Jasny", "Ciemny"]) - TO AKTUALNIE NIE DZIAŁA!!!
#if theme == "Ciemny":
#    st.markdown(
#        """
#        <style>
...
# json z opisem tych klastrów, który uzyskaliśmy na poprzednich zajęciach
...
# chce odczytać dane dla danego klastra, czyli używamy 'predict_model', żeby odczytać sobie do jakiego klastra 
# dzięki modelowi sztucznej inteligencji, została przydzielona osoba, którą sobie wymyśliliśmy wybierając opcje w aplikacji
# chcemy wykorzystać 'predicted_cluster_id', żeby pobrać dane
predicted_cluster_data = cluster_names_and_descriptions[predicted_cluster_id]  # patrz tu

st.header(f"Najbliżej Ci do grupy {predicted_cluster_data['name']}")  # działa tutaj 1 model
st.markdown(predicted_cluster_data['description'])  # a tu drugi!!!
